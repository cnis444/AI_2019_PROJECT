...
public class EndlessTerrain : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if ((viewverPositionOld - viewerPosition).sqrMagnitude > sqrviewerMoveThresholdForChunkUpdate)
        {
            viewverPositionOld = viewerPosition;
            UpdateVisibleChunks();
        }
    }
    ...
    public class TerrainChunk
    {
        ...
        public TerrainChunk(Vector2 coord, int size, LODInfo[] detailsLevels, Transform parent, Material material)
        {
            ...
            mapGenerator.RequestMapData(position, OnMapDataRecieve);
        }
